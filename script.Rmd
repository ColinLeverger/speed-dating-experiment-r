...
# Plot result
ggplot(int_corr.analysis, aes(x = int_corr, y = my.n, fill = factor(n.matches.cat))) +
  geom_bar(stat = "identity", position = "dodge") +
  scale_fill_discrete(name = "Matches") +
  xlab("int_cor") + ylab("Count") + 
  ggtitle("Does correlation between participant’s and partner’s ratings of interests really matter?") 
```
