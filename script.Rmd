...
checkDataQuality(
  df,
  out.file.num = "dqr/DQR_cont-before.csv",
  out.file.cat = "dqr/DQR_cat-before.csv"
)

# Read the DQR on the disk
dqr.cont.bef <- read.csv("dqr/DQR_cont-before.csv")
dqr.cat.bef  <- read.csv("dqr/DQR_cat-before.csv")
...
checkDataQuality(
  df,
  out.file.num = "dqr/DQR_cont-after.csv",
  out.file.cat = "dqr/DQR_cat-after.csv"
)
```

## Read DQR on the disk & check that everything is fine
```{r, results="hide"}
dqr.cont.aft <- read.csv("dqr/DQR_cont-after.csv")
dqr.cat.aft  <- read.csv("dqr/DQR_cat-after.csv")
